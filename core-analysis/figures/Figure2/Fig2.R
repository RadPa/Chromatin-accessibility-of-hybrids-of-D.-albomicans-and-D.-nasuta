...
res$lab <- gsub("NC_047627.1:627220-634590", "CG11110,CG11095,unchar¹", res$lab)
res$lab <- gsub("NC_047627.1:1131890-1132220", "unchar²", res$lab)
res$lab <- gsub("NC_047627.1:3423110-3423670", "lncRNA¹,kif4", res$lab)
res$lab <- gsub("NC_047627.1:5111120-5111730", "lncRNA²", res$lab)
res$lab <- gsub("NC_047627.1:6452860-6453120", "Ten-a", res$lab)
res$lab <- gsub("NC_047627.1:11669870-11670380", "SraP", res$lab) 
res$lab <- gsub("NC_047627.1:16239480-16243170", "unchar³", res$lab)
res$lab <- gsub("NC_047627.1:21930660-21930930", "unchar⁴", res$lab)
res$lab <- gsub("NC_047627.1:25897760-25898120", "unchar⁵", res$lab)
...
res$lab <- gsub("NC_047629.1:8769720-8771910", "Dr", res$lab)
...
res$lab <- gsub("NC_047631.1:1906960-1907380", "Pdss", res$lab)
res$lab <- gsub("NC_047631.1:18969030-18969350", "unchar¹", res$lab)
res$lab <- gsub("NC_047631.1:32214600-32219890", "Dscam2", res$lab)
res$lab <- gsub("NW_022995739.1:2217600-2217860", "flip", res$lab)
